...
export default defineConfig({
  ...
  manifest: {
    name: 'CampusCopilot for UW',
    short_name: 'CampusCopilot',
    description:
      'CampusCopilot for UW: a local-first academic decision workspace with cited AI over Canvas, Gradescope, EdStem, and MyUW.',
    icons: {
      16: 'icon-16.png',
      32: 'icon-32.png',
      48: 'icon-48.png',
