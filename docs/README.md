...
- **I want repo-local proof that the story is real**: [`verification-matrix.md`](verification-matrix.md), then [`site-capability-matrix.md`](site-capability-matrix.md), then [`live-validation-runbook.md`](live-validation-runbook.md)
