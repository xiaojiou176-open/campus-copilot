...
const commands = [
  ...
  { command: 'pnpm', args: ['--filter', '@opencampus/sdk', 'test'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/workspace-sdk', 'test'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/site-sdk', 'test'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/cli', 'test'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/mcp', 'test'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/mcp-readonly', 'build'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/mcp-readonly', 'test'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/mcp-server', 'build'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/mcp-server', 'test'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/provider-runtime', 'build'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/provider-runtime', 'test'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/gradescope-api', 'build'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/gradescope-api', 'test'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/edstem-api', 'build'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/edstem-api', 'test'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/myuw-api', 'build'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/myuw-api', 'test'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/cli', 'start', 'help'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/mcp-server', 'start', '--help'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/mcp-readonly', 'start:canvas', '--', '--help'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/mcp-readonly', 'start:gradescope', '--', '--help'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/mcp-readonly', 'start:edstem', '--', '--help'] },
  { command: 'pnpm', args: ['--filter', '@opencampus/mcp-readonly', 'start:myuw', '--', '--help'] },
  {
    command: 'pnpm',
    args: [
      '--filter',
