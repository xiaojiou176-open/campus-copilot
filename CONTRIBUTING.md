...
CampusCopilot is a local-first study workspace, not a generic chatbot demo.
...
`pnpm browser:launch` now opens or reuses the canonical CampusCopilot browser lane with a generated local identity tab under:
